 ...
 */
@Slf4j
public class WtaRankReptile {


    /**
     * 排名URL
     */
    private static final String RANK_URL = "https://www.rank-tennis.com/zh/rank/wta/s/year/query";
     ...
     * @param model 当前的对象
     */
    public static void pageWtaRank(ReptileModel model){
        try {
